...
/* MG32 Library version is V2.1 --------------------------------------------*/

#define __MG32_LIB_VERSION_MAIN             (0x02U) /*!< [15:8] main version */
#define __MG32_LIB_VERSION_SUB              (0x01U) /*!< [7:0]  sub version */
#define __MG32_LIB_VERSION                  ((__MG32_LIB_VERSION_MAIN << 8U) \
                                            |(__MG32_LIB_VERSION_SUB  << 0U))

/* MG32 Library release date is 2024-9-27 -----------------------------------*/
#define __MG32_LIB_RELESE_YEARH             (0x20U) /*!< [31:24] release year high */
#define __MG32_LIB_RELESE_YEARL             (0x24U) /*!< [23:16] release year low */
#define __MG32_LIB_RELESE_MONTH             (0x09U) /*!< [15:8]  release month */
#define __MG32_LIB_RELESE_DAY               (0x27U) /*!< [7:0]   release day */
#define __MG32_LIB_RELESE_DATE              ((__MG32_LIB_RELESE_YEARH << 24U) \
                                            |(__MG32_LIB_RELESE_YEARL << 16U) \
                                            |(__MG32_LIB_RELESE_MONTH <<  8U) \
                                            |(__MG32_LIB_RELESE_DAY   <<  0U))


/**
  * @brief  MG32 MCU Interrupt Handle
  */
typedef enum IRQn 
{
